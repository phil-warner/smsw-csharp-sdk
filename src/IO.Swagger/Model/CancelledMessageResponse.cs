...
namespace IO.Swagger.Model
{
    ...
    public partial class CancelledMessageResponse :  IEquatable<CancelledMessageResponse>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CancelledMessageResponse);
        }

        /// <summary>
        /// Returns true if CancelledMessageResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CancelledMessageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelledMessageResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
