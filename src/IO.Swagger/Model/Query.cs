...
namespace IO.Swagger.Model
{
    ...
    public partial class Query :  IEquatable<Query>, IValidatableObject
    {
        ...
        public Query(string Status = default(string), string Destination = default(string), string Sender = default(string), string Keyword = default(string), string From = default(string), string To = default(string))
        {
            this.Status = Status;
